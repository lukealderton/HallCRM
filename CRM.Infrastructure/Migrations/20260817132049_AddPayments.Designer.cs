...
namespace CRM.Infrastructure.Migrations
{
    ...
    [Migration("20260817132049_AddPayments")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CRM.Core.Activities.Domain.Activity", b =>
                {
                    b.Property<Guid>("Id")
                    ...
                    b.HasIndex("CompletedUtc", "DueUtc");
            ...
            modelBuilder.Entity("CRM.Core.Invoices.Domain.Invoice", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier")
                        .HasColumnName("invId");
                    ...
                    b.Property<string>("AddressLine1")
                        .HasMaxLength(250)
                        .HasColumnType("nvarchar(250)")
                        .HasColumnName("invAddressLine1");

                    b.Property<string>("AddressLine2")
                        .HasMaxLength(250)
                        .HasColumnType("nvarchar(250)")
                        .HasColumnName("invAddressLine2");

                    b.Property<Guid?>("CompanyId")
                        .HasColumnType("uniqueidentifier")
                        .HasColumnName("invCompanyId");

                    b.Property<Guid?>("ContactId")
                        .HasColumnType("uniqueidentifier")
                        .HasColumnName("invContactId");

                    b.Property<string>("County")
                        .HasMaxLength(150)
                        .HasColumnType("nvarchar(150)")
                        .HasColumnName("invCounty");

                    b.Property<string>("CustomerName")
                        .HasMaxLength(300)
                        .HasColumnType("nvarchar(300)")
                        .HasColumnName("invCustomerName");

                    b.Property<DateTime?>("DueDateUtc")
                        .HasColumnType("datetime2")
                        .HasColumnName("invDueDateUtc");
                    ...
                    b.Property<DateTime?>("IssueDateUtc")
                        .HasColumnType("datetime2")
                        .HasColumnName("invIssueDateUtc");

                    b.Property<Guid>("JobId")
                        .HasColumnType("uniqueidentifier")
                        .HasColumnName("invJobId");

                    b.Property<string>("Notes")
                        .HasMaxLength(4000)
                        .HasColumnType("nvarchar(4000)")
                        .HasColumnName("invNotes");

                    b.Property<string>("Postcode")
                        .HasMaxLength(20)
                        .HasColumnType("nvarchar(20)")
                        .HasColumnName("invPostcode");
            ...
            modelBuilder.Entity("CRM.Core.Invoices.Domain.InvoiceLine", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                    ...
                    b.Property<string>("Description")
                        ...
                        .HasColumnName("inlDescription");

                    b.Property<Guid>("InvoiceId")
                        .HasColumnType("uniqueidentifier")
                        .HasColumnName("inlInvoiceId");

                    b.Property<decimal>("Quantity")
                        .HasPrecision(10, 2)
                        .HasColumnType("decimal(10,2)")
                        .HasColumnName("inlQuantity");

                    b.Property<Guid?>("ServiceId")
                        .HasColumnType("uniqueidentifier")
                        .HasColumnName("inlServiceId");

                    b.Property<int>("SortOrder")
                        .HasColumnType("int")
                        .HasColumnName("inlSortOrder");

                    b.Property<decimal>("UnitPrice")
                        .HasPrecision(18, 2)
                        .HasColumnType("decimal(18,2)")
                        .HasColumnName("inlUnitPrice");
                    ...
                    b.ToTable("T_InvoiceLine", (string)null);
                });
            ...
            modelBuilder.Entity("CRM.Core.Jobs.Domain.Job", b =>
                {
                    ...
                    b.Property<string>("AccessNotes")
                        ...
                        .HasColumnName("jobAccessNotes");

                    b.Property<string>("AddressLine1")
                        .HasMaxLength(250)
                        .HasColumnType("nvarchar(250)")
                        .HasColumnName("jobAddressLine1");
                    ...
                    b.Property<string>("SiteContactName")
                        .HasMaxLength(200)
                        .HasColumnType("nvarchar(200)")
                        .HasColumnName("jobSiteContactName");

                    b.Property<string>("SiteContactPhone")
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)")
                        .HasColumnName("jobSiteContactPhone");
                    ...
                    b.ToTable("T_Jobs", (string)null);
                });

            modelBuilder.Entity("CRM.Core.Jobs.Domain.JobServiceLink", b =>
                {
                    b.Property<Guid>("JobId")
                        .HasColumnType("uniqueidentifier")
                        .HasColumnName("jbsJobId");

                    b.Property<Guid>("ServiceId")
                        .HasColumnType("uniqueidentifier")
                        .HasColumnName("jbsServiceId");
                    ...
                    b.Property<decimal>("Quantity")
                        ...
                        .HasColumnType("decimal(10,2)")
                        .HasDefaultValue(1m)
                        .HasColumnName("jbsQuantity");

                    b.Property<decimal?>("UnitPrice")
                        .HasPrecision(18, 2)
                        .HasColumnType("decimal(18,2)")
                        .HasColumnName("jbsUnitPrice");

                    b.HasKey("JobId", "ServiceId");

                    b.HasIndex("ServiceId");

                    b.ToTable("T_JobService", (string)null);
                });
            ...
            modelBuilder.Entity("CRM.Core.Payments.Domain.Payment", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier")
                        .HasColumnName("payId");
                    ...
                    b.Property<DateTime>("PaymentDateUtc")
                        .HasColumnType("datetime2")
                        .HasColumnName("payPaymentDateUtc");

                    b.Property<string>("Reference")
                        .HasMaxLength(200)
                        .HasColumnType("nvarchar(200)")
                        .HasColumnName("payReference");
            ...
            modelBuilder.Entity("CRM.Core.Services.Domain.Service", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier")
                        .HasColumnName("svcId");
                    ...
                    b.Property<decimal?>("DefaultPrice")
                        .HasPrecision(18, 2)
                        .HasColumnType("decimal(18,2)")
                        .HasColumnName("svcDefaultPrice");

                    b.Property<string>("Description")
                        .HasMaxLength(2000)
                        .HasColumnType("nvarchar(2000)")
                        .HasColumnName("svcDescription");

                    b.Property<string>("Name")
                        .IsRequired()
                        .HasMaxLength(200)
                        .HasColumnType("nvarchar(200)")
                        .HasColumnName("svcName");

                    b.Property<string>("Notes")
                        .HasColumnType("nvarchar(max)")
                        .HasColumnName("svcNotes");

                    b.HasKey("Id");

                    b.ToTable("T_Service", (string)null);
                });
            ...
            modelBuilder.Entity("CRM.Core.Activities.Domain.Activity", b =>
                {
                    ...
                    b.HasOne("CRM.Core.Entities.Domain.CrmEntity", "Entity")
                        .WithOne()
                        .HasForeignKey("CRM.Core.Activities.Domain.Activity", "Id")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("CRM.Core.Jobs.Domain.Job", "Job")
                        .WithMany()
                        .HasForeignKey("JobId")
                        .OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity("CRM.Core.Invoices.Domain.Invoice", b =>
                {
                    ...
                    b.HasOne("CRM.Core.Entities.Domain.CrmEntity", "Entity")
                        .WithOne()
                        .HasForeignKey("CRM.Core.Invoices.Domain.Invoice", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("CRM.Core.Invoices.Domain.InvoiceLine", b =>
                {
                    b.HasOne("CRM.Core.Invoices.Domain.Invoice", "Invoice")
                        .WithMany("Lines")
                        .HasForeignKey("InvoiceId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CRM.Core.Services.Domain.Service", "Service")
                        .WithMany()
            ...
            modelBuilder.Entity("CRM.Core.Jobs.Domain.Job", b =>
                {
                    ...
                    b.HasOne("CRM.Core.Entities.Domain.CrmEntity", "Entity")
                        .WithOne()
                        .HasForeignKey("CRM.Core.Jobs.Domain.Job", "Id")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("CRM.Core.Payments.Domain.Payment", b =>
                {
                    b.HasOne("CRM.Core.Entities.Domain.CrmEntity", "Entity")
                        .WithOne()
                        .HasForeignKey("CRM.Core.Payments.Domain.Payment", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("CRM.Core.Services.Domain.Service", b =>
                {
                    b.HasOne("CRM.Core.Entities.Domain.CrmEntity", "Entity")
                        .WithOne()
                        .HasForeignKey("CRM.Core.Services.Domain.Service", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
